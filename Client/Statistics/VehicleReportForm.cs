...
namespace VTMS.Statistics
{
    public partial class VehicleReportForm : Office2007Form
    {
        ...
        {
            this.dataGridView.DataSource = VehicleDao.CaculateVehicleReport(this.startDate.Value.Date.AddMilliseconds(-1), this.endDate.Value.Date.AddDays(1).AddMilliseconds(-1), this.brand.Text).Tables[0];
        }
        #endregion
