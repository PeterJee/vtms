...
namespace NHibernate.Loader.Custom
{
	...
	public class CustomLoader : Loader
	{
        ...
        public DataSet QueryDataSet(Impl.SessionImpl sessionImpl, QueryParameters queryParameters)
        {
            return base.QueryDataSet(sessionImpl, queryParameters, querySpaces);
        }
	}
}