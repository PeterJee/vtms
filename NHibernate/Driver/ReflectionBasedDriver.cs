...
namespace NHibernate.Driver
{
	public abstract class ReflectionBasedDriver : DriverBase
	{
        ...
        //{
        //}
        protected ReflectionBasedDriver(string driverAssemblyName, string connectionTypeName, string commandTypeName, string adapterName = null)
            : this(null, driverAssemblyName, connectionTypeName, commandTypeName, adapterName)
        {
        }
        protected ReflectionBasedDriver(string providerInvariantName, string driverAssemblyName, string connectionTypeName, string commandTypeName, string adapterName = null)
        {
            ...
            var adapterType = ReflectHelper.TypeFromAssembly(adapterName, driverAssemblyName, false);
        ...
        {
            return connectionCommandProvider.CreateDataAdapter(command);
        }
	}
}